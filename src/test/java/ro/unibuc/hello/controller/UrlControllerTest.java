...
public class UrlControllerTest {
    ...
    public void testCreateShortUrl() throws Exception {
        ...
        when(urlShortenerService.createShortUrl(any(UrlRequest.class), eq("user123"), eq(true)))
            .thenReturn("abc123");
        ...
        verify(urlShortenerService).createShortUrl(any(UrlRequest.class), eq("user123"), eq(true));
    }
    ...
    public void testGetOriginalUrl() throws Exception {
        ...
        when(urlShortenerService.getOriginalUrl(shortUrl, false)).thenReturn(originalUrl);
        ...
        verify(urlShortenerService).getOriginalUrl(shortUrl, false);
    }
